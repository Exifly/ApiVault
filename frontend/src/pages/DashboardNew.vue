<script setup>
import Card from "@/newComponents/Card.vue";
import Footer from "@/newComponents/Footer.vue";
import Navbar from "../newComponents/Navbar.vue";
import Hero from "../newComponents/Hero.vue";
