            ...
            meta: [
                {
                    name: 'keywords',
                    content:
                        'free api, free api list, apivault, free apis for projects, open-source, public APIs, free apis for learning, free apis to use',
                },
                {
                    name: 'description',
                    content:
                        'ApiVault - The largest collection of free and public APIs, categorized for easy search.',
                },
                { name: 'author', content: 'exifly' },
                {
                    name: 'twitter:title',
                    content: 'A free API database list for developers',
                },
                {
